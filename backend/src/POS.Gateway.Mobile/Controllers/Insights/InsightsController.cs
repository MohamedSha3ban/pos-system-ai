...
namespace POS.Gateway.Mobile.Controllers.Insights;

/// <summary>Not currently called by the Flutter app's UI, but included so mobile has parity
/// if a reorder-suggestions screen gets added there later -- cheap to expose.</summary>
[ApiController]
[Authorize]
